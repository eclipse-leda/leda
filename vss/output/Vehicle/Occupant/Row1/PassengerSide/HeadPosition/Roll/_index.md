...
date: 2026-03-08T08:02:57.920137
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.Occupant.Row1.PassengerSide.HeadPosition.Roll](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.Occupant.Row1.PassengerSide.HeadPosition.Roll/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.Occupant.Row1.PassengerSide.HeadPosition.Roll` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.Occupant.Row1.PassengerSide.HeadPosition.Roll) |
