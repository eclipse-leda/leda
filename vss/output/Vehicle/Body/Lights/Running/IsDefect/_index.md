...
date: 2023-06-05T12:38:44.153787
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.Body.Lights.Running.IsDefect](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.Body.Lights.Running.IsDefect/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.Body.Lights.Running.IsDefect` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.Body.Lights.Running.IsDefect) |
