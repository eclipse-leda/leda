...
date: 2023-06-05T12:38:42.067629
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.Body.Horn.IsActive](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.Body.Horn.IsActive/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.Body.Horn.IsActive` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.Body.Horn.IsActive) |
