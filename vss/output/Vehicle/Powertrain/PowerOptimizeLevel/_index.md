...
date: 2023-06-05T12:38:36.808952
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.Powertrain.PowerOptimizeLevel](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.Powertrain.PowerOptimizeLevel/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.Powertrain.PowerOptimizeLevel` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.Powertrain.PowerOptimizeLevel) |
