...
date: 2023-06-05T12:39:05.932364
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.OBD.O2.Sensor2.ShortTermFuelTrim](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.OBD.O2.Sensor2.ShortTermFuelTrim/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.OBD.O2.Sensor2.ShortTermFuelTrim` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.OBD.O2.Sensor2.ShortTermFuelTrim) |
