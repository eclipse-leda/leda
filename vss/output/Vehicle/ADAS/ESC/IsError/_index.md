...
date: 2023-06-05T12:39:02.097124
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.ADAS.ESC.IsError](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.ADAS.ESC.IsError/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.ADAS.ESC.IsError` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.ADAS.ESC.IsError) |
