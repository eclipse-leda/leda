...
date: 2026-03-08T08:03:00.898972
no_list: true
---
...
|---|---|
| ACME Car (EV) v0.1 | [Vehicle.ControlUnit.Trunk.Health.Network.ETH.IsNetworkOK](https://digitalauto.netlify.app/model/STLWzk1WyqVVLbfymb4f/cvi/list/Vehicle.ControlUnit.Trunk.Health.Network.ETH.IsNetworkOK/) |

## Data Type & Unit

| | | |
|---|---|---|
| Path | `Vehicle.ControlUnit.Trunk.Health.Network.ETH.IsNetworkOK` | [VSS: Addressing nodes](https://covesa.github.io/vehicle_signal_specification/rule_set/basics/) |
...
| | |
|---|---|
| Enhancement request | [Create COVESA GitHub Issue](https://github.com/COVESA/vehicle_signal_specification/issues/new?body=Please+describe+your+feedback&title=Signal+feedback+Vehicle.ControlUnit.Trunk.Health.Network.ETH.IsNetworkOK) |
